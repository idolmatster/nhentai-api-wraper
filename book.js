...
class doujin {
    constructor(title, id, tags, translated, artist, character, parody, language, title_link, page_count,) {
        this.title = title;
        this.id = id;
        this.tags = tags;
...
async function getDoujin(id) {
    ...
    return new doujin(title, id, tags, translated, artist, character, parody, language, title_link, page_count);
}
